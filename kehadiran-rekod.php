...
# memanggil fail luaran dan istihar pembolehubah.
include('header.php');
...
if(!empty($_POST['nokp'])){
    ...
    # menyemak adakan nokp yang dimasukkan telah wujud dalam pangkalan data
    ...
    if(mysqli_num_rows($laksana_arahan_semak)!=1)
    {
        ...
        $arahan_semak     =  "select* from kehadiran where nokp='".$_POST['nokp']."' and id_aktiviti ='".$_GET['id_aktiviti']."' limit 1";
...
$arahan_sql_kehadiran = "select* from ahli,aktiviti,kehadiran,pasukan
where
    ahli.nokp             = kehadiran.nokp
and ahli.id_pasukan       = pasukan.id_pasukan
